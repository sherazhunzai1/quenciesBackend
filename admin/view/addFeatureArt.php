          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Add Featured Artworks</h4>
...
$num = 0;
               ...
               <form action="../admin/api/featureart/addFeatureArt.php" method="post"> 
                             <tr>
    ...
    <ul class="pagination justify-content-center">
        <li class="page-item ">
            <a class="page-link"
                ...
                if($data->currentPage==1){echo "#";}
                     ...
                     --$prev;
                    echo  base_url."admin/view/addFeatureArt.php?pageno=".$prev;
                }
                ?>">Previous</a>
        </li>
       <?php
       ...
       ?>
        <li class="page-item <?php if($i==$page){echo "active";} ?>">
            <a class="page-link " href="<?php echo  base_url."admin/view/addFeatureArt.php?pageno=".$i; ?>"> <?php echo $i;?> </a>
        </li>
<?php
}
?>
        <li class="page-item">
            <a class="page-link"
                ...
                if($data->currentPage==$data->totalPages){echo "#";}
                    ...
                    echo  base_url."admin/view/addFeatureArt.php?pageno=".$next;
                }
                ?>">Next</a>
        </li>
    </ul>
