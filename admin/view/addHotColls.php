...
$num = 0;
               ...
               <form action="../admin/api/hotCollections/addHotColls.php" method="post"> 
                             <tr>
    ...
    <ul class="pagination justify-content-center">
        <li class="page-item ">
            <a class="page-link"
                ...
                if($data->currentPage==1){echo "#";}
                     ...
                     --$prev;
                    echo  base_url."admin/view/addHotColls.php?pageno=".$prev;
                }
                ?>">Previous</a>
        </li>
       <?php
       ...
       ?>
        <li class="page-item <?php if($i==$page){echo "active";} ?>">
            <a class="page-link " href="<?php echo  base_url."admin/view/addHotColls.php?pageno=".$i; ?>"> <?php echo $i;?> </a>
        </li>
<?php
}
?>
        <li class="page-item">
            <a class="page-link"
                ...
                if($data->currentPage==$data->totalPages){echo "#";}
                    ...
                    echo  base_url."admin/view/addHotColls.php?pageno=".$next;
                }
                ?>">Next</a>
        </li>
    </ul>
