          ...
          <ul class="nav">
            ...
            <a class="nav-link" href="dashboard.php">
              ...
              <a class="nav-link" href="./featureart.php">
                ...
                <i class="ti-layers menu-icon"></i>
                <span class="menu-title">Featured Audio</span>
              </a>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive pt-3">
                      <table class="table table-dark">
                        ...
                        <tbody>
                        <?php
                         $url = base_url."/admin/admin/api/nfts/readaudio.php";
$ch = curl_init();
...
$num=0;
                          ...
                          <tr>
                             ...
                             <a href= "https://libertynft.org/@<?php echo $row->owner_name; ?>" style = "color: white" >
                                 ...
                                 <td>
                            <a href ="https://libertynft.org/artwork/@<?php echo $row->creator_name;?>/<?php echo $row->product_name;?>--<?php echo $row->product_id ?>" target="_blank"  type="button" class="btn btn-secondary mt-2
                          ">View</a>
                            </td>
                          </tr>
                          <?php
