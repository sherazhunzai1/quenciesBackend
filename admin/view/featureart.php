        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <a class="nav-link" href="dashboard.php">
              ...
              <a class="nav-link" href="./RCAs.php">
                <i class="ti-layers menu-icon"></i>
                <span class="menu-title">RCA's</span>
              </a>
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Feature Artworks</h4>
                      <a href ="./addfeatureartworks.php" class="btn btn-primary mt-2 float-right"
                          >ADD</a>
                    <div class="table-responsive pt-3">
                      <table class="table table-dark">
                        ...
                        <tbody>
                        <?php
                         $url = base_url. "/admin/admin/api/featureart/read.php";
$ch = curl_init();
