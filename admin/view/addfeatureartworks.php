          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Featured Artworks</h4>
                    ...
                    <div class="table-responsive pt-3">
                      <table class="table table-dark">
                        ...
                        <tbody>
                        <?php
                         $url = base_url . "/admin/admin/api/nfts/read.php";
$ch = curl_init();
...
$num=0;
                          ...
                          <tr>
                             ...
                             <a href= "https://libertynft.org/@<?php echo $row->owner_name; ?>" style = "color: white" >
                                 ...
                                 <td>
                            <a href ="https://libertynft.org/admin/admin/api/featureart/add.php?id=<?php echo $row->product_id; ?>" class="btn btn-success mt-2
                          ">ADD</a>
                            </td>
                          </tr>
                          <?php
