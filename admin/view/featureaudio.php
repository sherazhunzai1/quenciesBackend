          ...
          <ul class="nav">
            ...
            <a class="nav-link" href="dashboard.php">
              ...
              <a class="nav-link" href="./featureart.php">
                <i class="ti-layers menu-icon"></i>
                <span class="menu-title">Featured Artworks</span>
              </a>
              <a class="nav-link" href="./featureaudio.php">
                <i class="ti-layers menu-icon"></i>
                <span class="menu-title">Featured Audios</span>
              </a>
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Feature Audios</h4>
                      <a href ="./addfeatureaudio.php" class="btn btn-primary mt-2 float-right"
                          >ADD</a>
                    <div class="table-responsive pt-3">
                      <table class="table table-dark">
                        ...
                        <tbody>
                        <?php
                         $url = base_url. "/admin/admin/api/featureaudio/read.php";
$ch = curl_init();
...
// $num=0;
                         ...
                         <form action="../admin/api/featureaudio/sequence.php" method="post">
...
<a href="../admin/api/featureaudio/delete.php?id=<?php echo $row->id; ?>"  class="btn btn-danger btn-sm m-1">
                                Delete
                              </a>
                            </td>
                          </tr>
