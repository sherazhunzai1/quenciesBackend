...
?>
        ...
        $page=1;
                        ...
                        $url = base_url."admin/admin/api/trendingcollection/readAlltrendingArts.php?pageno=".$page;
...
$i = 0;
                         ...
                         <form action="../admin/api/trendingcollection/sequence.php" method="post">  
    ...
    <ul class="pagination justify-content-center">
        <li class="page-item ">
            <a class="page-link"
                ...
                if($data->currentPage==1){echo "#";}
                     ...
                     --$prev;
                    echo  base_url."admin/view/trendingcollections.php?pageno=".$prev;
                }
                ?>">Previous</a>
        </li>
       <?php
       ...
       ?>
        <li class="page-item <?php if($i==$page){echo "active";} ?>">
            <a class="page-link " href="<?php echo  base_url."admin/view/trendingcollections.php?pageno=".$i; ?>"> <?php echo $i;?> </a>
        </li>
<?php
}
?>
        <li class="page-item">
            <a class="page-link"
                ...
                if($data->currentPage==$data->totalPages){echo "#";}
                    ...
                    echo  base_url."admin/view/trendingcollections.php?pageno=".$next;
                }
                ?>">Next</a>
        </li>
    </ul>
