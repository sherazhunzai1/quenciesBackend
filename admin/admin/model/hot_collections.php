...
class Hot_collections
{
    ...
    //create nft
     public function add_Hot_coll_Art($nft_id, $sequence)
    { 
        
         // Create query
  
        $query = 'INSERT INTO Hot_collections SET  nft_id =:nft_id
        , sequence =:sequence
        ';
...
WHERE  nft_id =:nft_id";
 ...
 public function getSeq()
    {   
        ...
        //single RCA's 
        $query = 'SELECT MAX(sequence) as seq FROM Hot_collections
